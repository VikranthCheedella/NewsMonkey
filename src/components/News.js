  ...
  render() {
    return (
      <div className="container">
        <h1 className="text-center" style={{marginTop: '90px', marginBottom: '35px', backgroundColor:"#0b0c10"}}>
          ...
          <div className="container">
            <div className="row">
              {this.state.articles.map((element) => {
                return (
                  <div className="col-xl-4 col-md-6 d-flex justify-content-center" key={element.url}>
                    <NewsItem
